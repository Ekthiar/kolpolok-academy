    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to='academy.schoolclass')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('designation', models.CharField(blank=True, help_text='যেমনঃ সিনিয়র শিক্ষক', max_length=100)),
                ('specialization', models.CharField(blank=True, help_text='যেমনঃ পদার্থবিজ্ঞান, গণিত', max_length=150)),
